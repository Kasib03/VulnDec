# cnn_bilstm_codebert_multiclass.py (optimized for local use)
...
import myutils  # make sure myutils.py is in the same folder
...
# -------- SAVE MODEL --------
model.save("model_multiclass_cnn_bilstm_codebert_blocks_optimized.h5")
print("Model saved as model_multiclass_cnn_bilstm_codebert_blocks_optimized.h5")
